...
function validatepatterns() {
  ...
  const code = `ValidatePattern:{
      input: 'email',
      pattern: /^\w+@[a-zA-Z_]+?\.[a-zA-Z]{2,3}$/,
      type: 'regex', // or wildcard
      when: 'typing',
      allowEmpty: false,
  ...
  return (
    <div id="my-rule-element" className="w-full h-screen flex justify-center">
      ...
      >
        ...
        <p className="text-md font-[500]">
          <span
            onClick={() =>
              window.open(
                "https://npmjs.com/package/form-validation-react#validate-pattern"
              )
            }
      ...
      <Head>
        <title>Validate Patterns - React</title>
        <link rel="icon" href={Logo.src} />
        <meta name="description" content="This function is used to validate input fields against a specific
            pattern, such as a regular expression or a wildcard pattern." />
            <meta
          property="og:image"
      ...
      <div className="h-full w-[600px]  pt-12 flex flex-col items-center">
        <div className="min-w-full  pt-3 pb-6 flex flex-col items-center">
          ...
          >
            This function is used to validate input fields against a specific
            pattern, such as a regular expression or a wildcard pattern.
          </motion.p>
        </div>
        <motion.div
          ...
          <ValidateForm
            ...
            rules={{
              ValidatePattern: {
                ...
                errorMessage:
                  "At least 8 characters long. Contains at least one uppercase letter. Contains at least one lowercase letter. Contains at least one number. Contains at least one special character",
                input: "password",
                when: "typing",
                type: "regex",
              },
